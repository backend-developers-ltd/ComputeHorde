...
```
aws s3 mb --region us-east-1 s3://compute_horde_executor-ijhava
```
...
The naming convention is `/application/compute_horde_executor/{env}/{path_of_the_file_to_be_created}`, for example `/application/project/staging/.env`.
