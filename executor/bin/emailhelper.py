...
if __name__ == "__main__":
    ...
    print(
        "Enter/Paste the message for email. Ctrl-%s to save it." % (os.name == "nt" and "Z" or "D")
    )
    message_lines = []
    while True:
        try:
    ...
    sender = GmailSender(
        email_creds.hostname, email_creds.port, email_creds.username, email_creds.password
    )
    print("Sending email...")
