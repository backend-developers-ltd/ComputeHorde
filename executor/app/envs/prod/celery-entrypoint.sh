...
OPTIONS="-A compute_horde_executor -E -l ERROR --pidfile=/var/run/celery-%n.pid --logfile=/var/log/celery-%n.log"
...
while true; do
    sleep 30
    celery -A compute_horde_executor status > /dev/null 2>&1 || exit 1
done
