...
VOLUME_MAX_SIZE_BYTES = env.int('VOLUME_MAX_SIZE_BYTES', default=104857600)  # 100MB
OUTPUT_ZIP_UPLOAD_MAX_SIZE_BYTES = env.int('OUTPUT_ZIP_UPLOAD_MAX_SIZE_BYTES', default=314572800)  # 300MB
