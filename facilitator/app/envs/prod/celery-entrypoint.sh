...
OPTIONS="-A project -E -l INFO --pidfile=/var/run/celery-%n.pid --logfile=/var/log/celery-%n.log"
...
trap "echo 'Received termination signal'; celery multi stop $WORKERS $OPTIONS; exit 0" INT TERM
