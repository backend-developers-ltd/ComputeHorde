...
def get_validators(netuid=12, network="finney") -> list['NeuronInfo']:
    ...
    neurons = [n for n in metagraph.neurons if (n.hotkey == BAC_VALIDATOR_SS58_ADDRESS or n.stake.tao >= MIN_STAKE)]
    neurons = sorted(neurons, key=lambda n: (n.hotkey == BAC_VALIDATOR_SS58_ADDRESS, n.stake), reverse=True)
