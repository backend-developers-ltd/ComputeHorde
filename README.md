...
- **Developer SDK for Easy Integration**  
  ...
  See [ComputeHorde SDK README](https://github.com/backend-developers-ltd/compute-horde-sdk#readme) for installation and usage examples.
...
check out the [ComputeHorde SDK](https://github.com/backend-developers-ltd/compute-horde-sdk#readme).
...
For installation, usage examples, and API reference, see the [ComputeHorde SDK README](https://github.com/backend-developers-ltd/compute-horde-sdk#readme).
...
- **SDK for Subnet Owners & Validators:**  
  [ComputeHorde SDK README](https://github.com/backend-developers-ltd/compute-horde-sdk#readme) – integrate ComputeHorde into your subnet's validator
