...
TASK_QUEUE_MAP = {
    ...
    # Metagraph Sync
    "compute_horde_validator.validator.miner_sync.sync_miners": "metagraph",
    ...
    "compute_horde_validator.validator.allowance.tasks.scan_archive_blocks_and_calculate_allowance": "metagraph",
