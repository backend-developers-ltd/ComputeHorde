...
def reserve_allowance(
    ...
    Transactional safety:
        Uses a two-phase locking strategy to avoid PostgreSQL limitation with FOR UPDATE on outer joins:
            Phase 1 - read candidate BlockAllowance IDs.
            Phase 2 - lock those rows with select_for_update(), re-check availability, then assign.
    """
