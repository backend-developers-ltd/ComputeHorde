...
class AllowanceMinerManifest(models.Model):
    ...
    executor_class = models.CharField(max_length=255, choices=[(choice.value, choice.value) for choice in ExecutorClass])
    is_drop = models.BooleanField(help_text="Whether the executor count is lower compared to the previously "
                                            "scraped value")
