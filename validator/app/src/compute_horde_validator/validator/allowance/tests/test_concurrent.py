...
def test_concurrent_reservations_serialized():
    ...
    # Patch allowance singleton to bypass supertensor usage in its __init__ (which tests fixture forbids)
...
def test_concurrent_evict_vs_reserve():
    ...
    Without proper transaction in reserve_allowance the following could occur:
    ...
    # Sanity: eviction should NOT remove these (they are fresh / above threshold). We still race.
