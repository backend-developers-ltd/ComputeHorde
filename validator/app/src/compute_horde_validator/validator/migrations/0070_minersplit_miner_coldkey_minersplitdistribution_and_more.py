# Generated by Django 4.2.19 on 2025-07-22 06:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('split', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='distributions', to='validator.minersplit')),
            ],
        ),
        migrations.AddIndex(
            model_name='minersplit',
            index=models.Index(fields=['coldkey', 'cycle_start'], name='validator_m_coldkey_54823d_idx'),
        ),
        migrations.AddIndex(
            model_name='minersplit',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('percentage__gte', 0), ('percentage__lte', 1)), name='valid_percentage_range'),
        ),
        migrations.AlterUniqueTogether(
            name='minersplitdistribution',
