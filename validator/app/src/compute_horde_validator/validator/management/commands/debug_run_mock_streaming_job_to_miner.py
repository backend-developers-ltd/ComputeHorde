...
async def run_streaming_job(options, wait_timeout: int = 300):
    ...
    async with contextlib.AsyncExitStack() as exit_stack:
        ...
        try:
            ...
            assert streaming_job_ready_response.message_type == RequestType.V0StreamingJobReadyRequest
            streaming_job_ready_response = cast(V0StreamingJobReadyRequest, streaming_job_ready_response)
