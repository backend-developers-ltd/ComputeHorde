...
class Job:
    ...
    def emit_telemetry_event(self) -> SystemEvent | None:
        ...
        data = dict(
            ...
            download_time_limit_seconds=self.job_generator.download_time_limit_seconds(),
            execution_time_limit_seconds=self.job_generator.execution_time_limit_seconds(),
            upload_time_limit_seconds=self.job_generator.upload_time_limit_seconds(),
