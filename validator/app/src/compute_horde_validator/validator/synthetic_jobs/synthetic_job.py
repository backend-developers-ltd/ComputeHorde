...
HASHJOB_PARAMS = {
    ...
    1: {
        Algorithm.SHA256: JobParams(timeout=90, num_letters=3, num_digits=0, num_hashes=50000),
        Algorithm.SHA384: JobParams(timeout=90, num_letters=3, num_digits=1, num_hashes=50000),
        Algorithm.SHA512: JobParams(timeout=90, num_letters=3, num_digits=1, num_hashes=50000),
    },
}
