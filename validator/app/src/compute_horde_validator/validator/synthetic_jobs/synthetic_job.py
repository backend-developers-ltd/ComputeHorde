...
HASHJOB_PARAMS = {
    ...
    1: {
        Algorithm.SHA256: JobParams(timeout=92, num_letters=6, num_digits=0, num_hashes=50000),
        Algorithm.SHA384: JobParams(timeout=95, num_letters=5, num_digits=1, num_hashes=50000),
        Algorithm.SHA512: JobParams(timeout=95, num_letters=5, num_digits=1, num_hashes=50000),
    },
}
