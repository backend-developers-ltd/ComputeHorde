...
HASHJOB_PARAMS = {
    ...
    1: {
        ...
        Algorithm.SHA384: JobParams(timeout=65, num_letters=5, num_digits=1, num_hashes=50000),
        Algorithm.SHA512: JobParams(timeout=65, num_letters=5, num_digits=1, num_hashes=50000),
    },
}
