...
def announce_address_and_port():
    ...
    logger.info(
        f"Announced port and address: {settings.BITTENSOR_MINER_ADDRESS}: {settings.BITTENSOR_MINER_PORT}"
    )
